#=================================================================
# This version of M10 is for calculating CL, Cm, CD and use in xp
#=================================================================
...
def M10_xp_calculate_CL_Cm_CD(Vt, FlightData_Geometric_c, alpha, alpha_dot, alpha_crit, X_flow_sep, U):
    """
    ...
    if whether_to_add_chris_high_aoa_correction_chris_version == 1:
        alpha_crit = -60 * (np.pi/180) # Please enter in deg
    #--------------------------------------------------------------------
