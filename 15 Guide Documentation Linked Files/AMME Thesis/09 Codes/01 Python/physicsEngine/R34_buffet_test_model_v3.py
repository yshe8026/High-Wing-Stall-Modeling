...
'''Essentially the same as R34_buffet_test_model v2, but with a small frequency correction factor'''
...
#-----------------------------------------------
plt.savefig(xplane11_path + "richard_science_plots\\example_1.pdf")
#-----------------------------------------------
...
#-----------------------------------------------
plt.savefig(xplane11_path + "richard_science_plots\\example_2.pdf")
#-----------------------------------------------
...
#-----------------------------------------------
plt.savefig(xplane11_path + "richard_science_plots\\example_3.pdf")
#-----------------------------------------------
