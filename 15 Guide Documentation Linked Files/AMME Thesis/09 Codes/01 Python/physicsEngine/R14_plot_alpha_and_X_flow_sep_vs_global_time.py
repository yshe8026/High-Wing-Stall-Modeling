...
if flag_whether_running_xplane == 1:
    ...
    x_flow_sep = df.iloc[150:, 4]  # assuming the fifth column is X_flow_sep
else:
...
if plot_alpha_unit_flag == 1:
    ax2 = ax1.twinx()
    ax2.plot(global_time, alpha, label='alpha vs. global_time', color=color1, linestyle='--')
...
plt.savefig('C:\\Users\\Richard\\00 Richard Apps\\Steam\\steamapps\\common\\X-Plane 11\\richard_checked_terms\\X_flow_sep_and_alpha.png')  # Save as PNG
plt.show()
