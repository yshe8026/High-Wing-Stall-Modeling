...
whether_to_plot_U = 0
# input field
whether_to_plot_stage2_combined_history = 0
...
delta_e = flight_data_matrix[:, 26] # 26th column (delta_t) (elevator input) [rad]
delta_a = flight_data_matrix[:, 27] # 27th column (delta_t) (aileron input) [rad]
delta_r = flight_data_matrix[:, 28] # 28th column (delta_t) (rudder input) [rad]
delta_f = flight_data_matrix[:, 29] # 29th column (delta_t) (flap input) [rad]
