...
if plot_alpha_unit_flag == 0:
    ...
    ax1.plot(alpha_in_deg, x_flow_sep, label=r'$X$ vs. $\alpha$', color=color2)
    ...
    ax2.plot(alpha_in_deg, CL, label=r'$C_L$ vs. $\alpha$', color=color6, linestyle='-')
    ax2.plot(alpha_in_deg, poststall_on, label=r'poststall_on vs. $\alpha$', color=color7, linestyle='-')
    ax2.plot(alpha_in_deg, Cm, label=r'$C_m$ vs. $\alpha$', color=color8, linestyle='-')
    ax2.plot(alpha_in_deg, CD, label=r'$C_D$ vs. $\alpha$', color=color9, linestyle='-')
...
plt.savefig('C:\\Users\\Richard\\00 Richard Apps\\Steam\\steamapps\\common\\X-Plane 11\\richard_checked_terms\\X_flow_sep_CD_vs_alpha.png')  # Save as PNG
plt.show()
