...
if whether_to_plot_altitude_dependence == 1:
    ...
    plt.plot(altitudes, std_u, label='$\sigma_{u_{g}}$')
    plt.plot(altitudes, std_v, '--', label='$\sigma_{v_{g}}$')
    plt.plot(altitudes, std_w, ':', label='$\sigma_{w_{g}}$')
    ...
    plt.tight_layout()
    #-----------------------------------------------
    plt.savefig(xplane11_path + "richard_science_plots\\X_M14_turbulence_vs_altitude_and_airspeed_simplified\\std_u_std_v_std_w_vs_h.pdf")
    #-----------------------------------------------
    plt.show()
    ...
    # plt.plot(altitudes, std_v, '--', label='std_v')
    # plt.plot(altitudes, std_w, label='std_w')
    plt.plot(altitudes, std_p, label='$\sigma_{p_{g}}$')
    plt.plot(altitudes, std_q, label='$\sigma_{q_{g}}$')
    plt.plot(altitudes, std_r, label='$\sigma_{r_{g}}$')
    plt.xlim(-100, 10000)    
    plt.xlabel('$h$ [m]')
    ...
    plt.tight_layout()
    #-----------------------------------------------
    plt.savefig(xplane11_path + "richard_science_plots\\X_M14_turbulence_vs_altitude_and_airspeed_simplified\\std_p_std_q_std_r_vs_h.pdf")
    #-----------------------------------------------
    plt.show()
...
# User input
whether_to_plot_velocity_dependence = 1

if whether_to_plot_velocity_dependence == 1:

    # Plotting
    plt.figure(figsize=(6.49,3), dpi=600)
    plt.plot(airspeeds, std_u, label='$\sigma_{u_{g}}$')
    plt.plot(airspeeds, std_v, label='$\sigma_{v_{g}}$')
    ...
    plt.tight_layout()
    #-----------------------------------------------
    plt.savefig(xplane11_path + "richard_science_plots\\X_M14_turbulence_vs_altitude_and_airspeed_simplified\\std_u_std_v_vs_TAS.pdf")
    #-----------------------------------------------
    plt.show()
    ...
    plt.plot(airspeeds, std_w, label='$\sigma_{w_{g}}$')
    # plt.plot(airspeeds, std_p, label='std_p')
    # plt.plot(airspeeds, std_q, label='std_q')
    # plt.plot(airspeeds, std_r, label='std_r')
    plt.xlabel('TAS [m/s]')
    ...
    plt.tight_layout()
    #-----------------------------------------------
    plt.savefig(xplane11_path + "richard_science_plots\\X_M14_turbulence_vs_altitude_and_airspeed_simplified\\std_w_vs_TAS.pdf")
    #-----------------------------------------------
    plt.show()
    ...
    # plt.plot(airspeeds, std_v, label='std_v')
    # plt.plot(airspeeds, std_w, label='std_w')
    plt.plot(airspeeds, std_p, label='$\sigma_{p_{g}}$')
    plt.plot(airspeeds, std_q, label='$\sigma_{q_{g}}$')
    plt.plot(airspeeds, std_r, label='$\sigma_{r_{g}}$')
    plt.xlabel('TAS [m/s]')
    plt.ylabel('$\sigma$ [rad/s]')
    ...
    plt.tight_layout()
    #-----------------------------------------------
    plt.savefig(xplane11_path + "richard_science_plots\\X_M14_turbulence_vs_altitude_and_airspeed_simplified\\std_p_std_q_std_r_vs_TAS.pdf")
    #-----------------------------------------------
    plt.show()
