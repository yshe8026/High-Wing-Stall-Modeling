...
fig = plt.figure(figsize=(6.49,3), dpi=600) # For correct font size, this needs: plt.tight_layout()
#-----------------------------------------------


plt.plot(J, eff, 'o', label='Original Data from BEM', markersize=2)
...
plt.tight_layout()
#-----------------------------------------------
plt.savefig(xplane11_path + "richard_science_plots\\X_R29_plot_prop_efficiency_interpolation_piecewise_v2\\eff_vs_J_with_piecewise_fit.pdf")
#-----------------------------------------------
