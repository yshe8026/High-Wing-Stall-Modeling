...
def dryden_psd(omega, V, b, L_u, L_v, L_w, sigma_u, sigma_v, sigma_w, plot_psd=0):
    ...
    if plot_psd:
        ...
        plt.tight_layout()
        #-----------------------------------------------
        plt.savefig(xplane11_path + "richard_science_plots\\X_M14_prepare_turbulence\\uvwpqr_PSDs_v_omega.pdf")
        #-----------------------------------------------
        plt.show()
...
def pdf(x, stan_dev_u, stan_dev_v, stan_dev_w, stan_dev_p, stan_dev_q, stan_dev_r, plot_pdf=0):
    ...
    if plot_pdf:
        ...
        plt.tight_layout()
        #-----------------------------------------------
        plt.savefig(xplane11_path + "richard_science_plots\\X_M14_prepare_turbulence\\uvw_PDFs_v_x.pdf")
        #-----------------------------------------------
        plt.show()
        ...
        plt.tight_layout()
        #-----------------------------------------------
        plt.savefig(xplane11_path + "richard_science_plots\\X_M14_prepare_turbulence\\pqr_PDFs_v_x.pdf")
        #-----------------------------------------------
        plt.show()
